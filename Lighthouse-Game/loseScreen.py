...
def display_losing_screen(screen, paused, run):
    paused = True
    ...
    while paused:
        ...
        text = font.render("You Died!", True, (255, 0, 0))  # Red color
        text2 = font2.render("You did not make it", True, (0, 0, 0))
        text3 = font2.render("to the top of the lighthouse!", True, (0, 0, 0))  # Red color
