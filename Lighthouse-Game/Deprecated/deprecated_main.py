...
# Initialize the arrow position to "Resume" by default
...
while run:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT:
                    ...
                    player.jump()
                # This code is what opens the pause menu
    ...
    # Pause Menu code
    if paused:
        from pauseMenu import display_pause_menu  # Import inside the loop to avoid circular import
        run, selected_option = display_pause_menu(screen, run, selected_option)
